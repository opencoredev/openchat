...
export const modules = {
  ...
  './streamContent.ts': () => import('./streamContent'),
  './streamMaintenance.ts': () => import('./streamMaintenance'),
  './streamQueries.ts': () => import('./streamQueries'),
  './streamTools.ts': () => import('./streamTools'),
  './streamUtils.ts': () => import('./streamUtils'),
  './chatFork.ts': () => import('./chatFork'),
  './chatReadStatus.ts': () => import('./chatReadStatus'),
  './chatTitle.ts': () => import('./chatTitle'),
  './chats.ts': () => import('./chats'),
  './cleanupAction.ts': () => import('./cleanupAction'),
  ...
  './userDeletion.ts': () => import('./userDeletion'),
