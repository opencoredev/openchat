...
/**
 * Sensitive storage keys that store chat content, drafts, and stream data.
 * These must be cleared from both sessionStorage and localStorage on sign-out
 * to prevent data leakage on shared devices.
 */
...
export async function signOut() {
  return authClient.signOut({
    fetchOptions: {
      onSuccess: () => {
        // Clear sensitive chat/draft/stream data from both storage types
