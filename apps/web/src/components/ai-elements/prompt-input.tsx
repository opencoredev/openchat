// ============================================================================
// PromptInput — orchestrator
//
// Sub-modules:
//   prompt-input-context.tsx  — contexts, hooks, PromptInputProvider
//   attachment-list.tsx       — attachment UI components
//   prompt-textarea.tsx       — textarea + speech button
//   prompt-toolbar.tsx        — toolbar, buttons, select, command, hover-card
// ============================================================================

// Re-export everything from sub-modules so consumers can import from here
export type {
	AttachmentsContext,
	TextInputContext,
...
// ============================================================================
// PromptInput — the main form component
// ============================================================================
...
export type PromptInputProps = Omit<HTMLAttributes<HTMLFormElement>, "onSubmit" | "onError"> & {
	...
	onSubmit: (
		message: { text: string; files: Array<FileUIPart> },
			...
			.then((convertedFiles: Array<FileUIPart>) => {
				try {
					...
					if (result instanceof Promise) {
						result
							.then(() => { clear(); if (usingProvider) controller.textInput.clear(); })
							.catch(() => {});
					} else {
						clear();
